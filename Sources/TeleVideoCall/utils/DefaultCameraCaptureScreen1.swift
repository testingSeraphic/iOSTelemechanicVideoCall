//
//  DefaultCameraCaptureScreen1.swift
...
public class DefaultCameraCaptureSource1: NSObject, CameraCaptureSource {
    ...
    let sinks = ConcurrentMutableSet()
...
extension DefaultCameraCaptureSource1: AVCaptureVideoDataOutputSampleBufferDelegate {
